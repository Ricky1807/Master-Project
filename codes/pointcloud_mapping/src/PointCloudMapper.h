...
//    float mresolution = 0.04;
        float mresolution = 100.0;
        float mDepthMapFactor = 1000.0;
        float mcx = 0, mcy = 0, mfx = 0, mfy = 0;
        float mMin = 0, mMax = 10.0;
//	float mcx=307.5731152770494, mcy=219.728057613463, mfx=740.1299012410317, mfy=730.1537099084879;
        ...
        vector <Eigen::Isometry3d> mvGlobalPointCloudsPose;  //欧式变换矩阵
